...
import metamaskIcon from "../../assets/settings/metamask-icon.svg";
        ...
        <Grid item className="button_group">
          ...
          <Tooltip
            ...
            title={
              ...
              >
                <Box className="fs-16-regular white">{t("tol-9_metamask")}</Box>
              </Stack>
            }
            PopperProps={{
              sx: {
          ...
          >
            <Button className="button_navbar_common" onClick={connect}>
